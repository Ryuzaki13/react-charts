...
export type ChartContextValue<TDatum> = {
    ...
    axisDimensionsState: [AxisDimensions, React.Dispatch<React.SetStateAction<AxisDimensions>>];
    focusedDatumState: [Datum<TDatum> | null, React.Dispatch<React.SetStateAction<Datum<TDatum> | null>>];
...
export type AlignPosition = "right" | "topRight" | "bottomRight" | "left" | "topLeft" | "bottomLeft" | "top" | "bottom";
...
export type AxisOptions<TDatum> = AxisTimeOptions<TDatum> | AxisLinearOptions<TDatum> | AxisBandOptions<TDatum>;

export type AxisOptionsWithScaleType<TDatum> = TSTB.Object.Required<AxisOptions<TDatum>, "scaleType">;

export type BuildAxisOptions<TDatum> = TSTB.Object.Required<AxisOptions<TDatum>, "position" | "scaleType">;
...
export type AxisTime<TDatum> = Omit<AxisBase & ResolvedAxisOptions<AxisTimeOptions<TDatum>>, "format"> & {
    isPrimary?: boolean;
    isInvalid: boolean;
    axisFamily: "time";
...
export type AxisLinear<TDatum> = Omit<AxisBase & ResolvedAxisOptions<AxisLinearOptions<TDatum>>, "format"> & {
    isPrimary?: boolean;
    isInvalid: boolean;
    axisFamily: "linear";
...
export type AxisBand<TDatum> = Omit<AxisBase & ResolvedAxisOptions<AxisBandOptions<TDatum>>, "format"> & {
    isPrimary?: boolean;
    isInvalid: boolean;
    axisFamily: "band";
    scale: ScaleBand<any>;
