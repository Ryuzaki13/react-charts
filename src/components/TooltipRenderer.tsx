...
export default function tooltipRenderer<TDatum>(props: TooltipRendererProps<TDatum>) {
...
function TooltipRenderer<TDatum>(props: TooltipRendererProps<TDatum>) {
    ...
    const { primaryAxis, secondaryAxis, getDatumStyle, focusedDatum, secondaryAxes } = props;
            ...
            <div>
                ...
                >
                    {tooltip.groupingMode === "series" ? (
                        ...
                        <strong>
                            {(secondaryAxis as AxisTime<any>).formatters.tooltip(focusedDatum.secondaryValue)}
                        </strong>
                    ) : (
                        <strong>{(primaryAxis as AxisTime<any>).formatters.tooltip(focusedDatum.primaryValue)}</strong>
                    )}
                </div>
                <table
                    style={{
                ...
                >
                    <tbody>
                        ...
                        {visibleSortedGroupDatums.map((sortedDatum, i) => {
                            ...
                            const datumSecondaryAxis = secondaryAxes.find(d => d.id === sortedDatum.secondaryAxisId);
                                ...
                                >
                                    ...
                                    {tooltip.groupingMode === "series" ? (
                                        <React.Fragment>
                                            ...
                                            >
                                                {(datumSecondaryAxis as AxisTime<any>).formatters.tooltip(
