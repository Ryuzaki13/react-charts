...
export function defaultTooltip<TDatum>(options: boolean | TooltipOptions<TDatum> = {}): ResolvedTooltipOptions<TDatum> {
    if (options === true) {
        options = { show: true };
...
export default function Tooltip<TDatum>(): React.ReactPortal | null {
    const { focusedDatumState, getOptions, primaryAxis, secondaryAxes, getDatumStatusStyle, svgRef } =
    ...
    const anchorEl = React.useMemo(() => {
        const anchorRect = latestFocusedDatum?.element?.getBoundingClientRect() ?? null;
              ...
              >
                  ...
                  >
                      {getOptions().tooltip.render({
                          ...
                          secondaryAxes,
                          secondaryAxis,
                          getDatumStyle: (datum: Datum<TDatum>) => getDatumStatusStyle(datum, focusedDatum),
                          anchor,
                      })}
                  </div>
              </div>,
